...
function cargarIconos() {
  iconos = [
    `<img src="img/_cat.jpg">`,
    `<img src="img/_dog.jpg">`,
    `<img src="img/_brush.jpg">`,
    `<img src="img/_book.jpg">`,
    `<img src="img/_orange.jpg">`,
    `<img src="img/_moon.jpg">`,
    `<img src="img/_sun.jpg">`,
    `<img src="img/_grape.jpg">`,
    `<img src="img/_water.jpg">`,
    `<img src="img/_banana.jpg">`,
    `<img src="img/_pear.jpg">`,
    `<img src="img/_apple.jpg">`,
  ];
}
    ...
    tarjetas.push(`
        <div class="card-area" onclick="cardSelector(${i})">
            <div class="card" id="card${i}">
                ...
                <div class="face back"><img src="img/_reverse.jpg"></div>
            </div>
        </div>
      `);
    if (i % 2 == 1) {
