...
function bloquearTarjetas() {
  for (let i = 0; i < 16; i++) {
    ...
    tarjetaBloqueada.innerHTML = `<img src="frutas/${numbers[i]}.png" alt="${numbers[i]}">`;
...
function mostrar(id) {
  ...
  // tarjeta1.innerHTML = `<img src="img/${firstResult}.png" alt="${firstResult}">`;
  ...
  if (tarjetasDestapadas === 1) {
    ...
    tarjeta1.innerHTML = `<img src="frutas/${firstResult}.png" alt="${firstResult}">`;
    ...
    tarjeta2.innerHTML = `<img src="frutas/${secondResult}.png" alt="${secondResult}">`;
